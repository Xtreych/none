...
BesTelegram = "https://t.me/besmsk"
BesTextUrl = "Bes"
SerjTelegram = "https://t.me/Ghostmane20"
SerjTextUrl = "Ghostmane20"
...
async def open_admin_panel(message: Message):
    if db.is_admin(message.from_user.id):
        await message.answer(
            ...
            f'<a href="{BesTelegram}">{BesTextUrl}</a>\n'
            f"<a href='{SerjTelegram}'>{SerjTextUrl}</a>\n\n"
